...
public class RequestAccountToCadidate
{
    ...
    public RequestAccountToCadidate(string username, string hashPassword, string firstName, DateTime date,
        string lastName, string email, string phone, string gender, string address)
    {
        Username = username;

...
public class PostImplement : PostService
{
    ...
    public async Task<List<ResponsePostCompany>> GetPostLocation(string location)
    {
        var postLocation = await _postRepository.GetPostByLocation(location);
    ...
    public async Task<List<ResponsePostCompany>> GetPostSalary(double salary)
    {
        var postSalary = _postRepository.GetPostBySalary(salary);
